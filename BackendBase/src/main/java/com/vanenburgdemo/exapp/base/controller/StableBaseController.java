...
import com.vanenburgdemo.exapp.base.service.IStableBaseService;
...
public abstract class StableBaseController<SERVICE extends IStableBaseService<M>, M extends StableBase>
		extends BaseWebService<SERVICE, M> {
	
	
	public StableBaseController(SERVICE logic) {
		super(logic);
	}
	
	
	//@PreAuthorize("hasAccess('/stables/autosuggest')")
	...
	//@PreAuthorize("hasAccess('/stables/bysid/{sid}')")
	@GetMapping(path = "/bysid/{sid}", produces = "application/json")
	public M getBySid(@PathVariable("sid") String sid) {
		return logic.getBySid(sid);
	}


	//@PreAuthorize("hasAccess('/stables/')")
	@PutMapping
	...
	//@PreAuthorize("hasAccess('/stables/datatable')")
	...
	//@PreAuthorize("hasAccess('/stables/{ids}')")
	@DeleteMapping("/{ids}")
	...
	//@PreAuthorize("hasAccess('/stables/{sid}')")
