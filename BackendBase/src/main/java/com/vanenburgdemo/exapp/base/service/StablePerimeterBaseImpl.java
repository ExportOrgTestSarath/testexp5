...
import com.vanenburgdemo.exapp.base.model.constants.StableConstantBase;
...
@Component
public abstract class StablePerimeterBaseImpl<T extends StableBase> implements IPerimeterManager<T>, StableConstantBase {
	
	private Logger LOGGER = LoggerFactory.getLogger(StablePerimeterBaseImpl.class);
	...
	protected void setReadFields(ApplicationUserBase userBase, AllowedFields allowedFields) {
		...
		if(userBase == null) {
			...
			String[] readFields = new String[] {SID, CREATED_BY, CREATED_DATE, MODIFIED_BY, MODIFIED_DATE, ONE, TWO};
