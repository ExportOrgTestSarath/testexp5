...
export class AppLayoutBaseService {
  ...
  config : any = {"left":[{"outline":false,"infiniteScroll":false,"urlIconFileName":"Company Logo.svg","valueChange":true,"logoFileName":"Company Logo.svg","currentNode":"a09b59b6-3954-41e7-a955-178fa8b16370","mobileLogoFileName":"Company Logo.svg","element":"logo"},{"outline":false,"menuType":"fixed","hideSidebarOnCollapse":false,"element":"leftMenu"},{"outline":false,"element":"appTitle"}],"middle":[{"outline":false,"element":"leftPane"},{"outline":false,"element":"middlePane"},{"outline":false,"element":"rightPane"}],"right":[{"children":[{"outline":false,"link":"/logout","label":"Logout","element":"logout"}],"element":"user"},{"outline":false,"menuType":"float","element":"rightMenu"}]};
